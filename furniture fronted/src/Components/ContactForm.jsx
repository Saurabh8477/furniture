...
function ContactForm() {
  ...
  //////////////////////////////////////////////
  let [formData1, setFromData1] = useState({ firstName: "Saurabh" })
  let [formData2, setFromData2] = useState({ lastName: "Dandotiya" })
  let [formData3, setFromData3] = useState({ email: "saurabh@gmail.com" })
  let [formData4, setFromData4] = useState({ message: "hello saurabh !!" })
